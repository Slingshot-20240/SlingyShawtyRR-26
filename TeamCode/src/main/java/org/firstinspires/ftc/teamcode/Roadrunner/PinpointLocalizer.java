...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 2000; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1475; // x position of the perpendicular encoder (in tick units)
    }
